...
const Field = ({
  ...
  className: className,
  "data-field": name,
  "data-validate": validate ? true : required ? true : false,
  "data-pattern": validate,
  "data-validity": validity,
  "data-required": required,
  onBlur: onBlur
}, !component.label && label && React.createElement("label", {
  htmlFor: name
}, label), component.label && component.label(label), component && component({
  name,
  label,
  value,
  defaultValue,
...
class Wizard extends Component {
  ...
  goToStep(index) {
    var i,
        dots = this.rootEl.querySelectorAll(".wizard__progress span");
    ...
    steps[index].style.display = "block"; //... and fix the Previous/Next buttons:
  ...
  render() {
    ...
    return React.createElement("div", {
      ...
      onSubmit: onSubmit
    }, steps.map((step, idx) => React.createElement("div", {
      className: "wizard__step",
      key: step.name,
      "data-step-index": idx
    }, step.title && React.createElement("h3", {
      className: "wizard__step-title"
    }, this.translate(`steps.${step.name}.title`) || step.title), step.sections.map(section => React.createElement(FormSection, {
      key: section.name,
    ...
    }, this.translate('actions.previous') || 'Previous'), React.createElement("button", {
      type: "button",
      id: "wizNextBtn",
      onClick: this.nextStep
    }, this.translate(this.state.canSubmit ? 'actions.finish' : 'actions.next') || 'Next')), React.createElement("div", {
      className: "wizard__progress"
    }, steps.map((s, index) => React.createElement("span", {
      key: index,
      title: s.caption
    })))));
  }
  ...
  componentDidMount() {
    ...
    this.goToStep(0); // build regex cache
